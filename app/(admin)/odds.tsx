  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#0a0a0a" }}>
      <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", padding: 16 }}>
        <Text style={{ color: "#fff", fontSize: 22, fontWeight: "700" }}>Quản lý tỷ lệ</Text>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 16, paddingTop: 0 }}>
        {matches.map((match) => (
          ...
          >
            <Text style={{ color: "#737373", fontSize: 11, marginBottom: 6 }}>{match.leagueName}</Text>
            ...
            {editingId === match.id ? (
              <View>
                ...
                <View style={{ flexDirection: "row", gap: 10 }}>
                  ...
                  >
                    <Text style={{ color: "#737373", fontWeight: "600" }}>Hủy</Text>
                  </TouchableOpacity>
                  <TouchableOpacity
              ...
              <View>
                <View style={{ flexDirection: "row", gap: 8, marginBottom: 14 }}>
                  {[
                    ...
                    <View key={label} style={{ flex: 1, backgroundColor: "#262626", borderRadius: 10, paddingVertical: 10, alignItems: "center" }}>
                      <Text style={{ color: "#737373", fontSize: 11, marginBottom: 3 }}>{label}</Text>
